...
@section('content')
    ...
    <section class="page-title page-title-layout6 bg-overlay bg-parallax">
      <div class="bg-img"><img src="{{asset('frontend/assets/images/page-titles/6.jpg')}}" alt="background"></div>
      <div class="container">
        <div class="row">
    ...
    <section class="features-layout2 pt-130 pb-0 mb-130">
      <div class="bg-img"><img src="{{asset('frontend/assets/images/backgrounds/7.jpg')}}" alt="background"></div>
      <div class="container">
