            ...
            <ul class="navbar-nav ml-auto">
                  ...
                  <li class="nav__item">
                    <div class="row mx-0">
                      <div class="col-sm-6 dropdown-menu-col">
                        <a href="services" class="nav__item-link dropdown-menu-title">Hardware Services</a>
                        <ul class="nav flex-column">
                          <li class="nav__item"><a class="nav__item-link" href="services">Mantainence
                              </a>
                          </li> <!-- /.nav-item -->
                          <li class="nav__item"><a class="nav__item-link" href="services">Devics configration</a>
                          </li> <!-- /.nav-item -->
                          
                          
                          
                          <li class="nav__item"><a class="nav__item-link" href="services">IT Support</a>
                          </li>
                          <!-- /.nav-item -->
                        </ul>
                      </div><!-- /.col-sm-6 -->
                      <div class="col-sm-6 dropdown-menu-col">
                        <a href="services" class="nav__item-link dropdown-menu-title">Software Services</a>
                        <ul class="nav flex-column">
                          <li class="nav__item"><a class="nav__item-link"
                              href="services">Web Application</a></li> <!-- /.nav-item -->
                          <li class="nav__item"><a class="nav__item-link"
                              href="services">Android/IOs Application</a></li> <!-- /.nav-item -->
                          <li class="nav__item"><a class="nav__item-link"
                              href="services">Desktop Application</a></li> <!-- /.nav-item -->
              ...
              <li class="nav__item  has-dropdown">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="nav__item">
                    <a href="fasq" class="nav__item-link">Help & FAQs</a>
                  </li> <!-- /.nav-item -->
